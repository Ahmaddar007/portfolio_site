    ...
    <>
      ...
      <div className="mb-32">
        ...
        <div className="relative flex gap-4 justify-center overflow-hidden py-10">
          <div className="group border border-gray-300 shadow-md hover:shadow-lg relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 ring-gray-900/5 transition-all duration-500 hover:-translate-y-5  sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
