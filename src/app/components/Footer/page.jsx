                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="mt-6 space-y-5">
                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> About </a>
                            </li>

                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> Features </a>
                            </li>

                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> Works </a>
                            </li>

                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> Career </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="mt-6 space-y-4">
                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> Customer Support </a>
                            </li>

                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> Delivery Details </a>
                            </li>

                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> Terms & Conditions </a>
                            </li>

                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> Privacy Policy </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="mt-6 space-y-5">
                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> Free eBooks </a>
                            </li>

                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> Development Tutorial </a>
                            </li>

                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> How to - Blog </a>
                            </li>

                            <li>
                                <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200"> YouTube Playlist </a>
                            </li>
                        </ul>
                    </div>
