  ...
  return (
    <div>
        <div className="relative flex gap-4 justify-center overflow-hidden py-10">
            ...
            <div
                className="group border border-gray-300 shadow-md hover:shadow-lg relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 ring-gray-900/5 transition-all duration-500 hover:-translate-y-5  sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
                ...
                <div className="relative z-10 mx-auto max-w-md">
                    ...
                    <div
                        className="space-y-6 pt-5 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
                        <ul>
                           <li className='py-2 border-b border-gray-200' >Lorem, ipsum dolor sit amet consectetur</li>
                           <li className='py-2 border-b border-gray-200' >Lorem, ipsum dolor sit amet consectetur</li>
                           <li className='py-2  border-gray-200' >Lorem, ipsum dolor sit amet consectetur</li>
                        </ul>
                    </div>
